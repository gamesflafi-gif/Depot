...
def cmd_strategy(cfg, args) -> None:
    ...
    res = strat.run_strategy_backtest(
        ...
        regime_filter=getattr(args, "regime", False),
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pst.add_argument("--regime", action="store_true",
                     help="Regime-Bremse aktivieren (defensiv in Abschwüngen; in Bullenmärkten kostet sie Rendite)")
